...
public class Collisionneur {
    ...
    public boolean isCollision(Position currentPosition, Position nextPosition, Carte carte){
        ...
        Tuile t = carte.getTuile(nextX/32,nextY/32);
        boolean b = carte.getTuile(nextX/32,nextY/32).getTraversable();
